    ...
    <div class ="container-fluid">
        ...
        <div class="jumbotron">
            ...
            <div class="form-inline">
                ...
                <asp:DropDownList ID="ddlAccountType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlAccountType_SelectedIndexChanged" CssClass="form-control" Width="150px">
            ...
            <div id="enterEmail" runat="server" class="form-inline" hidden="hidden">
                <br />
                Enter Email:<br />
                <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" Width="150px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="validEmail" Enabled="false" runat="server" ControlToValidate="txtEmail" ForeColor="#CC0000" ErrorMessage="*Required"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="regexEmailValid" Enabled="false" runat="server" ForeColor="#CC0000" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="txtEmail" ErrorMessage="*Invalid Email Format"></asp:RegularExpressionValidator>
            </div>
            <br />
