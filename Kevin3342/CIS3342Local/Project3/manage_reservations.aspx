<%@ Page Language="C#" MasterPageFile="~/KelpMaster.Master" AutoEventWireup="true" CodeBehind="manage_reservations.aspx.cs" Inherits="Project3.manage_reservations" %>
<asp:Content ID="ManageReservationsContent" ContentPlaceHolderID="ManageReservationsContent" runat="server">
     <div class="jumbotron" style="background-color: #CCFFCC">
        <h4>Manage Reservations</h4><br /><br />
        <h4 id="restHeader" runat="server">Restaurant Name</h4><br /><br />
